...
Deno.serve(async (req: Request) => {
  ...
  try {
    // TODO [ai-generate-vocab-practice]:
    ...
    return json({ function: 'ai-generate-vocab-practice', status: 'scaffold', message: 'Implement according to docs/03_IMPLEMENTATION_PLAN.md' }, 501);
  } catch (error) {
