...
Deno.serve(async (req: Request) => {
  ...
  try {
    // TODO [ai-generate-combined-review]:
    ...
    return json({ function: 'ai-generate-combined-review', status: 'scaffold', message: 'Implement according to docs/03_IMPLEMENTATION_PLAN.md' }, 501);
  } catch (error) {
