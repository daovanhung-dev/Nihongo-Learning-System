...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    return json({ function: 'ai-generate-listening', status: 'scaffold', message: 'Implement according to docs/03_IMPLEMENTATION_PLAN.md' }, 501);
  } catch (error) {
