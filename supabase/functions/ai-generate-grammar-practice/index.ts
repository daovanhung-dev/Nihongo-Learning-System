...
Deno.serve(async (req: Request) => {
  ...
  try {
    // TODO [ai-generate-grammar-practice]:
    ...
    return json({ function: 'ai-generate-grammar-practice', status: 'scaffold', message: 'Implement according to docs/03_IMPLEMENTATION_PLAN.md' }, 501);
  } catch (error) {
